...
#if SFMT_MEXP == 607
  #include "SFMT-params607.hpp"
#elif SFMT_MEXP == 1279
  #include "SFMT-params1279.hpp"
#elif SFMT_MEXP == 2281
  #include "SFMT-params2281.hpp"
#elif SFMT_MEXP == 4253
  #include "SFMT-params4253.hpp"
#elif SFMT_MEXP == 11213
  #include "SFMT-params11213.hpp"
#elif SFMT_MEXP == 19937
  #include "SFMT-params19937.hpp"
#elif SFMT_MEXP == 44497
  #include "SFMT-params44497.hpp"
#elif SFMT_MEXP == 86243
  #include "SFMT-params86243.hpp"
#elif SFMT_MEXP == 132049
  #include "SFMT-params132049.hpp"
#elif SFMT_MEXP == 216091
  #include "SFMT-params216091.hpp"
#else
#if defined(__GNUC__) && !defined(__ICC)
